...
describe('FlowNodeInspector', () => {
  ...
  it('renders an empty selection message', () => {
    render(<FlowNodeInspector agents={[]} definition={definition} selectedNode={null} onDeleteNode={vi.fn()} onUpdateNode={vi.fn()} />)
  ...
  it('updates human node fields', () => {
    const onUpdateNode = vi.fn()
    render(<FlowNodeInspector agents={[]} definition={definition} selectedNode={definition.nodes[1]} onDeleteNode={vi.fn()} onUpdateNode={onUpdateNode} />)
  ...
  it('updates condition rules and mode', () => {
    const onUpdateNode = vi.fn()
    render(<FlowNodeInspector agents={[]} definition={definition} selectedNode={definition.nodes[2]} onDeleteNode={vi.fn()} onUpdateNode={onUpdateNode} />)
  ...
  it('adds rules and updates AI evaluator prompts', () => {
    ...
    render(<FlowNodeInspector agents={[]} definition={definition} selectedNode={aiCondition} onDeleteNode={vi.fn()} onUpdateNode={onUpdateNode} />)
  ...
  it('documents merge nodes as pass-through markers', () => {
    render(<FlowNodeInspector agents={[]} definition={definition} selectedNode={definition.nodes[3]} onDeleteNode={vi.fn()} onUpdateNode={vi.fn()} />)
