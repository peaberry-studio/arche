...
function buildSessionWhere(filters: ProviderUsageFilters): Prisma.SessionWhereInput {
  return {
    ...(filters.from || filters.to
      ? {
          createdAt: {
...
function metadataMatchesFilters(metadata: unknown, filters: ProviderUsageFilters): boolean {
...
export async function listProviderUsageSessions(filters: ProviderUsageFilters): Promise<Array<{
  id: string
  user: { id: string; email: string; slug: string } | null
  userId: string
  createdAt: string
...
export async function listProviderUsageAuditEvents(filters: ProviderUsageFilters): Promise<Array<{
  id: string
  action: string
