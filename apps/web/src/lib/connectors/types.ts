export const CONNECTOR_TYPES = ['linear', 'notion', 'zendesk', 'umami', 'custom'] as const
export type ConnectorType = (typeof CONNECTOR_TYPES)[number]

export const SINGLE_INSTANCE_CONNECTOR_TYPES = ['linear', 'notion', 'zendesk', 'umami'] as const satisfies readonly ConnectorType[]
