...
export type DocxSourceDocument = {
  markdown: string
  path: string
}

export type DocxDocumentBundle = {
  appendices: DocxSourceDocument[]
  availablePaths: string[]
  primary: DocxSourceDocument
}
...
export function resolveDocxInternalLink(
  rawTarget: string,
  sourcePath: string,
  availablePaths: string[],
...
export function findDirectDocxDocumentPaths(
  markdown: string,
  sourcePath: string,
  availablePaths: string[],
): string[] {
  ...
  function addTarget(rawTarget: string, syntax: "markdown" | "obsidian") {
    const resolved = resolveDocxInternalLink(rawTarget, sourcePath, availablePaths, syntax)
...
export function getDocxDocumentTitle(document: DocxSourceDocument): string {
...
export function getObsidianDocxLinkLabel(rawTarget: string): string {
