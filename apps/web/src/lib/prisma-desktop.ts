...
const SCHEMA_DDL = [
  ...
  `CREATE TABLE IF NOT EXISTS "flows" (
    ...
    "organization_can_run" BOOLEAN NOT NULL DEFAULT false,
  ...
  `CREATE TABLE IF NOT EXISTS "flow_runs" (
    ...
    "created_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" DATETIME NOT NULL,
    CONSTRAINT "flow_runs_flow_id_fkey" FOREIGN KEY ("flow_id") REFERENCES "flows" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "flow_runs_execution_user_id_fkey" FOREIGN KEY ("execution_user_id") REFERENCES "users" ("id") ON DELETE SET NULL ON UPDATE CASCADE
  )`,
  `CREATE TABLE IF NOT EXISTS "flow_run_steps" (
    ...
    "created_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" DATETIME NOT NULL,
    CONSTRAINT "flow_run_steps_run_id_fkey" FOREIGN KEY ("run_id") REFERENCES "flow_runs" ("id") ON DELETE CASCADE ON UPDATE CASCADE
  )`,
  ...
  `CREATE INDEX IF NOT EXISTS "flows_user_id_name_idx" ON "flows"("user_id", "name")`,
  `CREATE INDEX IF NOT EXISTS "flows_visibility_idx" ON "flows"("visibility")`,
  `CREATE INDEX IF NOT EXISTS "flows_visibility_organization_can_run_idx" ON "flows"("visibility", "organization_can_run")`,
  `CREATE INDEX IF NOT EXISTS "flows_enabled_next_run_at_idx" ON "flows"("enabled", "next_run_at")`,
  `CREATE INDEX IF NOT EXISTS "flows_lease_expires_at_idx" ON "flows"("lease_expires_at")`,
  `CREATE INDEX IF NOT EXISTS "flows_user_id_lease_expires_at_idx" ON "flows"("user_id", "lease_expires_at")`,
  `CREATE UNIQUE INDEX IF NOT EXISTS "flow_runs_opencode_session_id_key" ON "flow_runs"("opencode_session_id")`,
  `CREATE INDEX IF NOT EXISTS "flow_runs_flow_id_started_at_idx" ON "flow_runs"("flow_id", "started_at")`,
  `CREATE INDEX IF NOT EXISTS "flow_runs_execution_user_id_idx" ON "flow_runs"("execution_user_id")`,
  `CREATE INDEX IF NOT EXISTS "flow_runs_status_idx" ON "flow_runs"("status")`,
  `CREATE INDEX IF NOT EXISTS "flow_runs_scheduled_for_idx" ON "flow_runs"("scheduled_for")`,
  `CREATE INDEX IF NOT EXISTS "flow_runs_retry_scheduled_for_idx" ON "flow_runs"("retry_scheduled_for")`,
  `CREATE INDEX IF NOT EXISTS "flow_run_steps_run_id_idx" ON "flow_run_steps"("run_id")`,
  `CREATE INDEX IF NOT EXISTS "flow_run_steps_status_idx" ON "flow_run_steps"("status")`,
  `CREATE UNIQUE INDEX IF NOT EXISTS "flow_run_steps_run_id_node_id_key" ON "flow_run_steps"("run_id", "node_id")`,
