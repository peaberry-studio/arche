...
export type MarkdownSourceDocument = {
  markdown: string
  path: string
}

export type MarkdownDocumentBundle = {
  appendices: MarkdownSourceDocument[]
  availablePaths: string[]
  primary: MarkdownSourceDocument
}

export type MarkdownInternalLink =
  | { kind: "external" }
...
export function getMarkdownAstText(node: MarkdownAstNode): string {
...
export function resolveMarkdownInternalLink(
  ...
  if (syntax === "markdown") {
    ...
    if (extension && extension !== ".md") return { kind: "external" }
  }
...
export function findDirectMarkdownDocumentPaths(
  markdown: string,
  sourcePath: string,
  availablePaths: string[],
): string[] {
...
export function getMarkdownDocumentTitle(document: MarkdownSourceDocument): string {
...
export function getObsidianMarkdownLinkLabel(rawTarget: string): string {
